...
<body style="overflow-x:hidden">
    ...
    <form action="" method="post">
        <h1 align="center" style="margin-top: 50px;">아이 추가</h1>
        <table>
            <tr>
        ...
        <div style="margin-left: 36%; margin-bottom: 50px;">
            <input type="button" value="아이추가" class="submit"><input type="submit" value="완료" class="submit" onclick="location.href='myUser.jsp'" style="margin-left: 50px;"> <input type="button" value="취소" style="margin-left: 50px;"
