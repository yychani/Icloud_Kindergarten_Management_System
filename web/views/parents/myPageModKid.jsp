...
<body style="overflow-x:hidden">
    ...
    <form action="" method="post">
        <h1 align="center" style="margin-top: 50px;">아이 정보 수정</h1>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2" class="input"><input type="text" id="userNumber1" style="width: 80%; height: 20px; background:rgb(224, 224, 224);" readonly>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2" class="input"><input type="text"  id="bloodType"
        ...
        <div style="margin-left: 36%; margin-bottom: 50px;">
            <input type="button" value="아이추가" class="submit" onclick="location.href='myUserAddKid.jsp'"><input type="submit" value="완료" class="submit" onclick="location.href='myUser.jsp'" style="margin-left: 50px;"> <input type="button" value="취소" style="margin-left: 50px;"
                class="cancel"  onclick="location.href='myUser.jsp'">
        </div>
