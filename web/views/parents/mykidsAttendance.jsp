...
<div class="ui segment attendanceType" style="margin:0 auto; width:500px;">
  결석 춠석 지각 조퇴
  
</div>
<div class="ui segment attendanceType" style="margin:0 auto; width:500px;">
<label>12월 박건후 어린이 출석사항</label><br>
<label>출석 : 10일</label><br>
<label>결석 : 0일</label><br>
<label>조퇴 : 0일</label>
