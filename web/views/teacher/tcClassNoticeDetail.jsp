...
<body>
	...
	<div class="ui form">
		<div class="field">
			...
			re value="<%=b.getTcont()%>" readonly></textarea>
		</div>
		
	</div>
	<br>
	 <%if(loginUser != null && loginUser.getUType().equals("교사")) {%>
	 <input type="submit" id="boardReWrite" value="수정하기" onclick="location.href='<%=request.getContextPath() %>/selectBoard.bo?num=<%=b.getTid() %>'" style="float: right" /><span style="float: right">&nbsp;&nbsp;</span> 
	 <%} %>
