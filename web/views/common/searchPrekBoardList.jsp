...
<body style="overflow-x: hidden">
	<%if (list.get(0).getTwriter() ==1) {%>
		<%@ include file="/views/common/presidentMenu.jsp"%>
	<%} else if(list.get(0).getTwriter()==2){ %>
		<%@ include file="/views/common/teacherMenu.jsp" %>
	<%} else if(list.get(0).getTwriter() ==3){%>
	...
	<script>
	if(list.get(1).list.get(1).getTwriter() ==1) {
		$(function() {
			$(".li1").addClass("on");
	...
	} else if(list.get(1).list.get(1).getTwriter() ==2){
		$(function() {
