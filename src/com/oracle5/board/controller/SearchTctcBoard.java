...
/**
 * Servlet implementation class SearchTctcBoard
 */
@WebServlet("/searchTctc.bo")
public class SearchTctcBoard extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchTctcBoard() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page="views/teacher/tcTcBoardSearchPage.jsp";
