 ...
 */
@WebServlet("/selectFLetterList.tbo")
public class SelectAllTcFamilyLetterListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectAllTcFamilyLetterListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new BoardService().getFamilyListCount();
