...
/**
 * Servlet implementation class SearchFamilyLetterServlet
 */
@WebServlet("/searchFamilyLetter.bo")
public class SearchFamilyLetterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchFamilyLetterServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((loginUser).getUType().equals("교사")){
			page="views/teacher/tcFamilyLetterSearchPage.jsp";
		}else if((loginUser).getUType().equals("학부모")){
			page="views/parents/newsFamilyLSearchPage.jsp";
		}
