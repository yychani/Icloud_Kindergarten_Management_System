...
/**
 * Servlet implementation class SearchChildImgServlet
 */
@WebServlet("/searchChildImg.bo")
public class SearchChildImgServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchChildImgServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((loginUser).getUType().equals("교사")){
			page="views/teacher/tcChildImgSearchPage.jsp";
		}else {
			page="views/parents/boardThumbnailSearchPage.jsp";
		}
