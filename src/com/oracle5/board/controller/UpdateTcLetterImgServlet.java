...
/**
 * Servlet implementation class UpdateTcLetterImgServlet
 */
@WebServlet("/updateFLetterImg.tbo")
public class UpdateTcLetterImgServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateTcLetterImgServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			int result = new BoardService().updateFLetterImg(attachment);
